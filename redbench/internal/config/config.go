...
type Test struct {
	...
	// Workload selects the workload flavor: "set_get" (default) or "mset_mget"
	...
	SameSlotPerClient bool `yaml:"sameSlotPerClient" json:"sameSlotPerClient"`
	// ApplyBatchExpiration, when true, applies expiration to keys in batch workloads (MSET followed by EXPIRE per key)
	ApplyBatchExpiration bool `yaml:"applyBatchExpiration" json:"applyBatchExpiration"`
}
